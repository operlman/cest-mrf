%% compiles the pulseq_mrf_cest mex file
function compile_pulseq_mrf_cest()
...
mex(opt_flag, i_eigen, i_pulseq, f_sbb, f_bmc, f_sp, f_es, '-output', fullfile(script_fp,'pulseq_cest_mex'));
